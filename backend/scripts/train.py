...
def train_with_swift(
    ...
    **kwargs,
    ...
    argv: list[str] = [
        ...
        "false",
        "--max_length",
        str(kwargs.get("max_length", 1024)),
        "--logging_steps",
...
def main():
    ...
    parser.add_argument("--logging_steps", type=int, default=5, help="日志步频")
    parser.add_argument("--save_steps", type=int, default=200, help="保存步频")
    parser.add_argument("--eval_steps", type=int, default=200, help="评估步频")
